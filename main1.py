...
# ================= CONFIGURATION =================
TOKENS 1 = [
    "8549116394:AAGz0SlaBv9G0w3jURlm1EDpQmHAvPExzgo",
]
TOKENS 2 = [ "8229275902:AAHV0UOdOOr75X-YtTDAsEveQXZLF-Fp560"]
TOKENS 3 = ['8641515315:AAEITZ-wCfh8XvtH9mCd-3vb-jGmfD3UpCo" ]
OWNER_ID = 7879852447

TEAM_A_TOKENS = TOKENS[:max(1, len("8229275902:AAHV0UOdOOr75X-YtTDAsEveQXZLF-Fp560")//2)]
TEAM_B_TOKENS = TOKENS[max(1, len("8641515315:AAEITZ-wCfh8XvtH9mCd-3vb-jGmfD3UpCo"):]
active_shift = "A"
...
async def dashboard_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = f"""
📊 **DASHBOARD — TEAM AKKU BOT **
━━━━━━━━━━━━━━━━━━━━
⏱️ Uptime: `{uptime}s`
🤖 Total Bots: `{len(TOKEN1)["8229275902:AAHV0UOdOOr75X-YtTDAsEveQXZLF-Fp560")}`
( TOKEN 2 [8549116394:AAGz0SlaBv9G0w3jURlm1EDpQmHAvPExzgo")]
(TOKEN 3
[8641515315:AAEITZ-wCfh8XvtH9mCd-3vb-jGmfD3UpCo")]
⚙️ Shift: `{active_shift}`
⚡ Speed: `{spd}s`
🔢 NC Delay: `{nc_dly}s`
━━━━━━━━━━━━━━━━━━━━
...
async def spam(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if not is_admin(update.effective_user.id): return
    chat_id = update.effective_chat.id
    message = " ".join(context.args) if context.args else "TECH X BOT V3"
...
🤖 Active Bots: `{len(TOKEN1)}`["8229275902:AAHV0UOdOOr75X-YtTDAsEveQXZLF-Fp560"]
(TOKEN 2) ["8549116394:AAGz0SlaBv9G0w3jURlm1EDpQmHAvPExzgo")]
(TOKEN 3) 
["8641515315:AAEITZ-wCfh8XvtH9mCd-3vb-jGmfD3UpCo")]
...
async def run_bots():
    if not TOKENS:
        print("8641515315:AAEITZ-wCfh8XvtH9mCd-3vb-jGmfD3UpCo, etc. as environment variables.")
        print("📌 8229275902:AAHV0UOdOOr75X-YtTDAsEveQXZLF-Fp560")
        return

    print(f"👑 TEAM AKKU BOT — BY AKKU BHAGWAN")
    print(f"🛡️ Team A: {len("8229275902:AAHV0UOdOOr75X-YtTDAsEveQXZLF-Fp560")} bots | 🛡️ Team B: {len("8641515315:AAEITZ-wCfh8XvtH9mCd-3vb-jGmfD3UpCo")} bots")
